...
// Функция для вывода настроек типа поля...Она создает объект определенного
// класса по его имени а тот класс уже
...
function SaveOptions($data) {
	...
	foreach ( $fields as $row ) {
		...
		// и вызываем метод сохранения в базу, передавая ему в качестве
